...
//int hePin1 = 2;
//int heValue1 = 0;
//Adafruit_NeoPixel strip1 = Adafruit_NeoPixel(LED_COUNT, LED_PIN, NEO_GRB + NEO_KHZ800);
//
//int MarioUW_note[] = {
...
//
//
////void turnStripOff(Adafruit_NeoPixel strip){
////  colorWipe(strip.Color(0,   0,   0), 0, strip);
////}
////
////
////void changeColor(int value, Adafruit_NeoPixel strip) {
////  if (value){
////    colorWipe(strip.Color(0,   255,   0), 50, strip);
////  } else { 
////    colorWipe(strip.Color(255,   0,   0), 50, strip);
////  }
////}
////
